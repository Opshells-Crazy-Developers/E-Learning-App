        ...
        <div className="mb-6">
          ...
          {activeTab === "courses" && (
            <div className="space-y-5">
              <div className="flex justify-between items-center">
                ...
                <Link to="/courses" className="text-purple-600 text-sm font-medium hover:text-purple-800">
                  View All
                </Link>
              </div>
                  ...
                  <div key={course.id} className="bg-white rounded-lg overflow-hidden shadow-sm border border-gray-100 hover:shadow-md transition-shadow">
                    ...
                    <div className="p-4">
                      ...
                      <div className="flex justify-between text-sm text-gray-500 mb-4">
                        <span>{course.lessonsCompleted} of {course.lessons} lessons</span>
          ...
          {activeTab === "recommended" && (
            <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-100 text-center py-12">
              <svg className="w-16 h-16 mx-auto text-purple-600 mb-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
              ...
              <p className="text-gray-500 mb-6">We're preparing personalized recommendations for you</p>
          ...
          {activeTab === "achievements" && (
            <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-100 text-center">
              ...
              <p className="text-gray-500">Keep up the great work! Achievements will appear here as you progress.</p>
            </div>
          )}
        </div>
      </div>
